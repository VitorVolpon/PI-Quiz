 ...
 * @author victor
 */
public class TelaLP extends javax.swing.JFrame {
...
//            java.util.logging.Logger.getLogger(TelaLP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        });   
    ...
    private void carregarPergunta() throws Exception {
        String sqlPerguntas = "SELECT * FROM perguntas WHERE idMateria = 4 ORDER BY idPergunta";
        ...
        try (
            ...
            while (rsPerguntas.next()) {
                ...
                String sqlAlternativas = "SELECT * FROM respostas WHERE idMateria = 4 AND idPergunta = ?";
                try (
    ...
    private void initComponents() {
        ...
        painel2Layout.setHorizontalGroup(
            ...
            .addGroup(painel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(vidaAluno, javax.swing.GroupLayout.DEFAULT_SIZE, 298, Short.MAX_VALUE)
        ...
        painelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(porcentagemP, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(vidaProfessor, javax.swing.GroupLayout.DEFAULT_SIZE, 338, Short.MAX_VALUE)
                .addContainerGap())
        );
        painelLayout.setVerticalGroup(
            ...
            .addGroup(painelLayout.createSequentialGroup()
                .addGroup(painelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(porcentagemP, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        getContentPane().add(painel, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, 420, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 1090, 90));
