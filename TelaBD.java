...
public class TelaBD extends javax.swing.JFrame{
    ...
    private void carregarPergunta() throws Exception {
        String sqlPerguntas = "SELECT * FROM perguntas WHERE idMateria = 3 ORDER BY idPergunta";
        ...
        try (
            ...
            while (rsPerguntas.next()) {
                ...
                String sqlAlternativas = "SELECT * FROM respostas WHERE idMateria = 3 AND idPergunta = ?";
                try (
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Imagens/pixil-frame-0 (5).png"))); // NOI18N
